...
> *This document is a copy of the* [`jupiter-notebook.md`](https://github.com/spacetelescope/style-guides/blob/master/guides/jupyter-notebooks.md) *document from [spacetelescope's style-guides repo](https://github.com/spacetelescope/style-guides)*
