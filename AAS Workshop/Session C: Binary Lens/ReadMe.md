...
This session will following along with this [notebook]({{ site.url }}{{ site.baseurl }}/data-challenge/aas-workshop/notebooks/binary/) on binary lens modelling:

<!-- Download and Github buttons -->
<div style="display: flex; gap: 10px; margin: 1em 0; align-items: center;">
  <a href="https://github.com/rges-pit/data-challenge-notebooks/blob/main/AAS Workshop/Session C: Binary Lens/Fitting_Binary_Lenses.ipynb" target="_blank"
  ...
  <a href="javascript:void(0)" 
      onclick="downloadNotebook('https://raw.githubusercontent.com/rges-pit/data-challenge-notebooks/main/AAS Workshop/Session C: Binary Lens/Fitting_Binary_Lenses.ipynb', 'Single_Lens_Pipeline.ipynb'); return false;"
