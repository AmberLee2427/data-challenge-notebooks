...
- [Slack](https://rmdc2026.slack.com)
...
For the remainer of the session will be following along with this [notebook](https://rges-pit.org/data-challenge/aas-workshop/notebooks/pipeline/):
